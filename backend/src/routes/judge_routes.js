...
router.put('/me/:invitationCode', requireJudgeInvitation, validateInvitationCode, validateJudge, judgeController.updateJudge);
...
router.get('/event/:invitationCode', requireJudgeInvitation, validateInvitationCode, judgeController.getEventForJudge);
